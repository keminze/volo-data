...
### 2026-04-13
本次新增了基于 DeepAgents 框架的实验版 BI Agent 服务，位于`/experimental_agent`，此 BI Agent 主要的功能为：人机交互、长期记忆、Skill 库、上下文压缩等。你需要注意的是，此 BI Agent 为实验性功能，所以我没有将其接入到主服务中，而是独立为另一个服务，与主服务几乎无关联。详情请查看[BI Agent 服务文档](experimental_agent\README.md)。
