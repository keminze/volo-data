...
class BigQuery_VectorStore(VannaBase):
    ...
    def store_training_data(
        self, training_data_type: str, question: str, content: str, embedding: List[float], **kwargs
    ) -> str:
        id = str(uuid.uuid4())
    ...
    def add_question_sql(self, question: str, sql: str, **kwargs) -> str:
        ...
        return self.store_training_data(
            training_data_type="sql", question=question, content=sql, embedding=embedding
        )
